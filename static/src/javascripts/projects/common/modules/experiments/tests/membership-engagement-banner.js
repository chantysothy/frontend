define([
    ...
    return [
        new EditionTest('uk')
            ...
            .addContributionsVariant('control', 'If you use it, if you like it, why not pay for it? It’s only fair. Contribute to the Guardian.')
            .addContributionsVariant('nofair',  'If you use it, if you like it, why not pay for it? Contribute to the Guardian.'),
        new EditionTest('us')
